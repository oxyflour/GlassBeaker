    ...
    *,
    ...
    return {
        ...
        "stages": [
            ...
            {"name": "descend_to_grasp", "kind": "move_pose", "pose": {"position": grasp_position, "quat_wxyz": quat_wxyz}, "target_point": "finger_center", "position_only": True, "steps": 24, "tolerance": 0.05},
